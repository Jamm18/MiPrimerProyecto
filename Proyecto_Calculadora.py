...
def TemaOscuro(*args):
    estilos.configure('mainframe.TFrame', background="gray10")
    
    estilos_label1.configure('Label1.TLabel', background="gray10", foreground="white")
    estilos_label2.configure('Label2.TLabel', background="gray10", foreground="white")

    estilos_botones_numeros.configure('Botones_numeros.TButton', background="red4", foreground="white")
    estilos_botones_numeros.map('Botones_numeros.TButton', background=[('active', '#020A90')])

    estilos_botones_borrar.configure('Botones_borrar.TButton', background="black", foreground="white")
    estilos_botones_borrar.map('Botones_borrar.TButton', background=[('active', '#000AB1')])

    estilos_botones_restantes.configure('Botones_restantes.TButton', background="black", foreground="white")
...
estilos.configure('mainframe.TFrame', background="steel blue1")
...
estilos_label1.configure('Label1.TLabel', font="arial 15", anchor="e", background="steel blue1")

estilos_label2 = ttk.Style()
estilos_label2.configure('Label2.TLabel', font="arial 40", anchor="e", background="steel blue1")
...
estilos_botones_numeros.configure('Botones_numeros.TButton', font="arial 22", width=5, background="sky blue", relief="flat")
estilos_botones_numeros.map('Botones_numeros.TButton', background=[('active', '#B9B9B9')])

estilos_botones_borrar = ttk.Style()
estilos_botones_borrar.configure('Botones_borrar.TButton', font="arial 22", width=5, background="steel blue", relief="flat")
estilos_botones_borrar.map('Botones_borrar.TButton', foreground=[('active', '#FF0000')])

estilos_botones_restantes = ttk.Style()
estilos_botones_restantes.configure('Botones_restantes.TButton', font="arial 22", width=5, background="steel blue", relief="flat")
estilos_botones_restantes.map('Botones_restantes.TButton', background=[('active', '#858585')])
